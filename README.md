OSP PANEL is a small application for managing and administrating polish VFD (Volunteer Fire Department). It contains features like adding and editing action details,
